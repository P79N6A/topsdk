    ...
    class Security {
        ...
        public static function encrypt($input, $key) {
            ...
            */
            ...
            $encrypted = openssl_encrypt($input, 'AES-128-CBC', $key, OPENSSL_RAW_DATA, $localIV); 
        ...
        public static function decrypt($sStr, $key) {
           ...
           /* $module = mcrypt_module_open(MCRYPT_RIJNDAEL_128, '', MCRYPT_MODE_CBC, $localIV);
            ...
            $decrypted = openssl_decrypt(base64_decode($sStr), 'AES-128-CBC', $key, OPENSSL_RAW_DATA, $localIV); 
