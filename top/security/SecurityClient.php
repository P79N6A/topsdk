...
include_once 'SecretGetRequest.php';
include_once 'TopSdkFeedbackUploadRequest.php';
...
class SecurityClient
{
	...
	function __construct($client, $random)
	{
		...
		$this->topClient->gatewayUrl = "https://eco.taobao.com/router/rest";
