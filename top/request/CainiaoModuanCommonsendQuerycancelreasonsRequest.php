<?php
/**
 * TOP API: cainiao.moduan.commonsend.querycancelreasons request
 * 
 * @author auto create
 * @since 1.0, 2017.05.08
 */
class CainiaoModuanCommonsendQuerycancelreasonsRequest
{
	/** 
	 * 外部用户ID
	 **/
	...
	{
		return "cainiao.moduan.commonsend.querycancelreasons";
	}
