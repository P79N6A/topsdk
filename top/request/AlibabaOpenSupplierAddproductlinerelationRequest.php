<?php
/**
 * TOP API: alibaba.open.supplier.addproductlinerelation request
 * 
 * @author auto create
 * @since 1.0, 2016.06.29
 */
class AlibabaOpenSupplierAddproductlinerelationRequest
{
	/** 
	...
	{
		return "alibaba.open.supplier.addproductlinerelation";
	}
