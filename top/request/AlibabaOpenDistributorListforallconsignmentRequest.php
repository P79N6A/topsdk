<?php
/**
 * TOP API: alibaba.open.distributor.listforallconsignment request
 * 
 * @author auto create
 * @since 1.0, 2016.06.29
 */
class AlibabaOpenDistributorListforallconsignmentRequest
{
	/** 
	 * 模糊查询关键字
	 **/
	...
	{
		return "alibaba.open.distributor.listforallconsignment";
	}
