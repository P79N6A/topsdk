<?php
/**
 * TOP API: alibaba.open.distributor.deletesupplyorder request
 * 
 * @author auto create
 * @since 1.0, 2016.06.29
 */
class AlibabaOpenDistributorDeletesupplyorderRequest
{
	/** 
	 * 采购单列表
	 **/
	...
	{
		return "alibaba.open.distributor.deletesupplyorder";
	}
